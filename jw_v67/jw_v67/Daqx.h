...
#if defined __TURBOC__ && !defined __WIN32__  //W.K.
   #define  DAQAPI; // to compile on WIN16
#else
...
#if defined __TURBOC__ && !defined __WIN32__ //W.K.
typedef  LONG   DaqHandleT; // to compile on WIN16
typedef  LONG *PBOOL;
typedef  void *PVOID;
typedef  char *PCHAR;
typedef  long INT;
...
DAQAPI DaqError WINAPI  daqGetDriverVersion(LPDWORD version);
...
typedef enum {
   ...
   #define DafCtrFallingEdge   0x10000L
   /* pDaq & Daq2000 Counter Types */
   #define DafCtrPulse         0x20000L
   #define DafCtrTotalize      0x40000L
   /* pDaq Digital and Counter Types */
   DafDioDirect         = 0x00000,
   #define DafCtrFreq          0x80000L
   #define DafCtrDutyLo        0x100000L
   #define DafCtrDutyHi        0x200000L

   /* pDaq Notch Frequencies */
   DafMeasDuration610   = 0x000000,
   #define DafMeasDuration370   0x100000L
   #define DafMeasDuration310   0x200000L
   #define DafMeasDuration130   0x300000L
   #define DafMeasDuration110   0x400000L
   #define DafMeasDuration40    0x500000L
   #define DafMeasDuration20    0x600000L
   #define DafMeasDuration12_5  0x700000L
   
   /* Daq2000 Settling Time Control */
   DafSettle5us         = 0x000000,
   #define DafSettle10us        0x800000L
   ...
   #define DafIgnoreType        0x1000000L
} _DaqAdcFlag;
typedef LONG DaqAdcFlag;
...
DAQAPI DaqError WINAPI  daqAdcSetMux(DaqHandleT handle, DWORD startChan, DWORD endChan, DaqAdcGain gain,
                           DWORD flags);
DAQAPI DaqError WINAPI  daqAdcSetScan(DaqHandleT handle, LPDWORD channels, DaqAdcGain *gains, LPDWORD flags,
                           DWORD chanCount);
DAQAPI DaqError WINAPI  daqAdcGetScan(DaqHandleT handle, LPDWORD channels, DaqAdcGain *gains, LPDWORD flags,
                           LPDWORD chanCount);
...
typedef enum {
        ...
        #define DaqTypeDigitalLocal  100000L
        #define DaqTypeDigitalExp    200000L
        #define DaqTypeCounterLocal  400000L
...
DAQAPI DaqError WINAPI  daqAdcSetTrigEnhanced(DaqHandleT handle, DaqAdcTriggerSource *trigSources,
                           ...
                           PFLOAT hysteresis, LPDWORD channels, DWORD chanCount, char *opStr);
...
DAQAPI DaqError WINAPI  daqAdcTransferSetBuffer(DaqHandleT handle, LPWORD buf, DWORD scanCount,
                           DWORD transferMask);
...
DAQAPI DaqError WINAPI  daqAdcTransferGetStat(DaqHandleT handle,
                           LPDWORD active, LPDWORD retCount);
...
DAQAPI DaqError WINAPI daqAdcTransferBufData(DaqHandleT handle, LPWORD buf, DWORD scanCount, DaqAdcBufferXferMask bufMask, LPDWORD retCount);


/* Custom ADC Acquisition Prototypes - Buffer Manipulation */
DAQAPI DaqError WINAPI  daqAdcBufferRotate(DaqHandleT handle, LPWORD buf, DWORD scanCount, DWORD chanCount,
                           DWORD retCount);

/* One-Step ADC Acquisition Prototypes */
DAQAPI DaqError WINAPI  daqAdcRd(DaqHandleT handle, DWORD chan, LPWORD sample, DaqAdcGain gain,
                           DWORD flags);
DAQAPI DaqError WINAPI  daqAdcRdScan(DaqHandleT handle, DWORD startChan, DWORD endChan,
                           LPWORD buf, DaqAdcGain gain, DWORD flags);
DAQAPI DaqError WINAPI  daqAdcRdN(DaqHandleT handle, DWORD chan, LPWORD buf, DWORD scanCount,
                           DaqAdcTriggerSource triggerSource, BOOL rising, WORD level, FLOAT freq,
                           DaqAdcGain gain, DWORD flags);
DAQAPI DaqError WINAPI  daqAdcRdScanN(DaqHandleT handle, DWORD startChan, DWORD endChan, LPWORD buf,
...
DAQAPI DaqError WINAPI daqCvtRawDataFormat(LPWORD buf, DaqAdcCvtAction action, DWORD lastRetCount,
...
DAQAPI DaqError WINAPI  daqDacWaveSetBuffer(DaqHandleT handle,
                           DaqDacDeviceType deviceType, DWORD chan,
                           LPWORD buf, DWORD scanCount, DWORD transferMask);
...
DAQAPI DaqError WINAPI  daqCvtLinearConvert(LPWORD counts, DWORD scans, PFLOAT fValues, DWORD nValues);
DAQAPI DaqError WINAPI  daqCvtLinearSetupConvert(DWORD nscan, DWORD readingsPos, DWORD nReadings,
                           ...
                           DWORD avg, LPWORD counts, DWORD scans, PFLOAT fValues, DWORD nValues);
...
DAQAPI DaqError WINAPI  daqCalSetup(DaqHandleT handle,DWORD nscan, DWORD readingsPos, DWORD nReadings,
                           ...
                           BOOL noOffset);
DAQAPI DaqError WINAPI  daqCalConvert(DaqHandleT handle, LPWORD counts, DWORD scans);
DAQAPI DaqError WINAPI  daqCalSetupConvert(DaqHandleT handle, DWORD nscan, DWORD readingsPos,
                           ...
                           BOOL bipolar, BOOL noOffset, LPWORD counts, DWORD scans);
...
DAQAPI DaqError WINAPI  daqCalGetConstants(DaqHandleT handle, DWORD channel, DaqAdcGain gain,
                           DaqAdcRangeT range, LPWORD gainConstant, PSHORT offsetConstant);
...
DAQAPI DaqError WINAPI  daqConfCalConstants(DaqHandleT handle, DWORD chan, DaqAdcGain gain,
                                            DaqAdcRangeT adcRange, LPWORD gainConst,
...
DAQAPI DaqError WINAPI  daqZeroSetup(DWORD nscan, DWORD zeroPos, DWORD readingsPos,
                           DWORD nReadings);
DAQAPI DaqError WINAPI  daqZeroConvert(LPWORD counts, DWORD scans);
DAQAPI DaqError WINAPI  daqZeroSetupConvert(DWORD nscan, DWORD zeroPos,
                           DWORD readingsPos, DWORD nReadings, LPWORD counts, DWORD scans);
...
DAQAPI DaqError WINAPI  daqCvtRtdConvert(LPWORD counts, DWORD scans, PSHORT temp, DWORD ntemp);
...
DAQAPI DaqError WINAPI  daqCvtRtdSetupConvert(DWORD nScan, DWORD startPosition, DWORD nRtd,
                           RtdType rtdType, DWORD avg, LPWORD counts, DWORD scans, PSHORT temp, DWORD ntemp);
...
DAQAPI DaqError WINAPI  daqCvtTCConvert(LPWORD counts, DWORD scans, PSHORT temp, DWORD ntemp);
...
DAQAPI DaqError WINAPI  daqCvtTCSetupConvert(DWORD nscan, DWORD cjcPosition, DWORD ntc,
                           TCType tcType, BOOL bipolar, DWORD avg, LPWORD counts, DWORD scans, PSHORT temp,
                           DWORD ntemp);
...
DAQAPI DaqError WINAPI  daq9513GetHold(DaqHandleT handle, DaqIODeviceType deviceType,
                           DWORD whichDevice, DWORD ctrNum, LPWORD ctrVal);
...
DAQAPI DaqError WINAPI  daqTest(DaqHandleT handle, DaqTestCommand command,
                           DWORD count, PBOOL cmdAvailable, LPDWORD result);
...
typedef enum {
   RtfDeviceRegs  = 0x0,
   #define RtfLptPort     0x10000L
   #define RtfDspDM       0x20000L
   #define RtfDspPM       0x30000L
} _RegTypeFlag;
typedef LONG RegTypeFlag;


DAQAPI DaqError WINAPI  daqRegWrite(DaqHandleT handle, DWORD reg, DWORD value);
DAQAPI DaqError WINAPI  daqRegRead(DaqHandleT handle, DWORD reg, LPDWORD value);
...
DAQAPI DaqError WINAPI  dspCmd(DaqHandleT handle, DWORD action, DWORD memType, DWORD addr, LPDWORD data);
...
DAQAPI DaqError WINAPI  daqAdcTransferStopAllocMem(DaqHandleT handle, LPWORD buf, DWORD scanCount);
...
DAQAPI DaqError WINAPI  daqIOTransferGetStat(DaqHandleT handle, DaqIODeviceType devType,
                           ...
                           DaqIOActiveFlag *active, LPDWORD retCount);
