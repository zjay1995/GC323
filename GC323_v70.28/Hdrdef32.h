...
typedef struct chinfo { /* information about each channel in file */
   ...
   unsigned short gaincd: 4; /* gain code for 1,2,5,10,50,100,500,1000,4,8,20,200,10000,100000 */
   unsigned short mvfscd: 4; /* mV full scale code for 5000,10000,2500,2048,1280,500000,1000000 */
...
typedef struct hdrcmn {
   ...
   long begtime; /* time acquistion opened file, sec since 1/1/70 */
   long endtime; /* time when file trailer was written */
